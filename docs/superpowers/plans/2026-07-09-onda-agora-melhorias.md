...
**Goal:** Implementar os 6 pacotes "Agora" da revisão estratégica (`docs/superpowers/specs/2026-07-09-revisao-estrategica-plataforma.md`): blindar o loop (A1), review falha-fechada + anti-parada-prematura (A2), notificação de pausa (A3), telemetria de autonomia/custo (A5), higiene do chat (A6) e contexto real no prompt (A4).
...
**Files:**
- Commit: `docs/superpowers/specs/2026-07-09-revisao-estrategica-plataforma.md` (untracked)

- [ ] **Step 0.1: Commit**

```bash
git add docs/superpowers/specs/2026-07-09-revisao-estrategica-plataforma.md docs/superpowers/plans/2026-07-09-onda-agora-melhorias.md
