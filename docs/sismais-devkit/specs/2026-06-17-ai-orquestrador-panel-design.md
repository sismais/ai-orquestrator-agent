...
└── docs/sismais-devkit/{specs,plans}/   # nossos specs/planos (este doc + DevKit migrado)
```
...
- **Docs:** a SPEC/planos do DevKit vão para `docs/sismais-devkit/{specs,plans}/` deste repo.
