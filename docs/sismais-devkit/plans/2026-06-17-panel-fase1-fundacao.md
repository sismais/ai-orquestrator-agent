...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) ou superpowers:executing-plans. Steps usam checkbox (`- [ ]`). **Esta é a Fase 1 de 4** (ver `docs/sismais-devkit/specs/2026-06-17-ai-orquestrador-panel-design.md`). Fases 2–4 (multi-projeto+workflow-config, runner no backend, board) ganham plano próprio depois.
...
- [ ] **Step 6: Documentar o resultado** — criar `docs/sismais-devkit/notes/2026-06-17-spike-skill-loading.md` com: abordagem vencedora (user-scope × worktree-copy), o comando que funcionou, e a decisão pro backend (como o runner vai disponibilizar as skills por run).
...
cd /d/Sismais/Fontes/ai-orquestrator-agent && git add spike/ docs/sismais-devkit/notes/ && git commit -m "spike(sdk): confirma carregamento de skill do DevKit em worktree"
```
...
> Pontos de acoplamento e arquivos catalogados em `docs/sismais-devkit/notes/2026-06-17-fork-code-map.md`.
...
**Files:**
- Create: `docs/sismais-devkit/notes/2026-06-17-fork-code-map.md`
...
- [ ] **Step 2: Commit**
```bash
git add docs/sismais-devkit/notes/2026-06-17-fork-code-map.md
