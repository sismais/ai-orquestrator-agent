...
> `docs/sismais-devkit/specs/2026-07-16-devkit-core-e-entrega-rapida-design.md`.
...
- **Scripts de estado** (`scripts/run-state.mjs`, `loop-state.mjs`): a orquestração e o estado
  ...
  (`docs/sismais-devkit/specs/2026-06-17-ai-orquestrador-panel-design.md`). Por isso as chamadas
...
Histórico de design e planos em `docs/sismais-devkit/{specs,plans}/`.
