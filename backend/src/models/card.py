...
class Card(Base):
    ...
    model_test: Mapped[str] = mapped_column(String(20), default="opus-4.8", nullable=False)
    model_review: Mapped[str] = mapped_column(String(20), default="opus-4.8", nullable=False)
